...
export const Navbar = ({
  ...
  return (
    <motion.div
      ...
      className={cn("sticky inset-x-0 top-5 z-40 w-full bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md", className)}>
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <IconX
      className="text-white hover:text-white transition duration-300 dark:text-white"
      onClick={onClick}
    />
  ) : (
    <IconMenu2
